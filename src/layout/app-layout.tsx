...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'fitness-trainer', 'sales-representative', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Brand', path: '/brands', entity: 'brand', service: AccessServiceEnum.PROJECT, icon: FiTag },
